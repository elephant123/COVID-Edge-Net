...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--log-root', type=str,
                            default='./sbd/log', help='set a log path folder')

        # checking point
        parser.add_argument('--resume', type=str, default=None,
                            help='put the path to resuming file if needed')
        parser.add_argument('--resume-dir', type=str, default='/media/DataHD/wk/covid/wk/DFF_canny_improatt/exps/runs/sbd/dff/dff/checkpoint_10.pth.tar',
